...
import { useGetPopularQuery } from '@/redux/apiStore';
// interface
...
const HomeMoviePopular = ({title}: Props) => {
  const page: number = 2

  const {data, isLoading, isFetching } = useGetPopularQuery({page})
...
export default HomeMoviePopular