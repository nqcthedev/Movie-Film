...
import {  useGetUpComingQuery } from '@/redux/apiStore';
// interface
...
const HomeMovieUpComing = ({title}: Props) => {
  const page: number = 2

  const {data, isLoading, isFetching } = useGetUpComingQuery({page})
...
export default HomeMovieUpComing